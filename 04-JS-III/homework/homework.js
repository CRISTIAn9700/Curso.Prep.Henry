...
function arrayContiene(array, elemento) {
  ...
  // Tu código:
  for (var i = 0; i < array.length; i++) {
    // luego ponemos una condicion en este caso if 
    if (array[i] === elemento) {
      return true
    }
...
function diaDeLaSemana(numeroDeDia) {
  ...
  } // aqui tambien podemos utilizar el metodo: "else" pero 
    // seria algo inncesario
...
function mayorACien(array) {
  ...
  for (var i = 0; i < array.length-1; i++) {
    ...
    if(array[i] > 100 ) nuevoArrayNumeros.push(array[i])
  } 
